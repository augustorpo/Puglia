...
function PicturesTab() {
  const pics = [
    ...
    { src: "/pics/fashion.jpg", caption: "Massimo's dress code para Puglia 👗☀️🤌", who: "📸 Il Concierge ha hablado · Coastal Chic para las mañanas de café, Euro Girl Summer para el aperitivo, y Sunset Siren para cuando Titi necesita... digo, para la cena. Lili y Fabi, tomen nota. Titi ya tomó nota seguro." },
